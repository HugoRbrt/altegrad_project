...
CFG_EXPERIMENTS = {
    0:{  
        'who': 'baptiste',
        'learning_rate': 2e-5,
        'name_exp': "GAT + skip + harn nedgative loss + scheduler linear + float16 + batch 200 + with_fast_tokenizer + n_heads_text:8 + n_layers_text:4 + freeze 2 first layers + embedding",
        'scheduler': 'lineair',
        'nb_epochs': 20,
        'batch_size': 200,
